...
<body>
            ...
            while ($row_motor = mysqli_fetch_assoc($result_motor)) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button onclick="konfirmasiHapus(<?= $row_motor['id_Kendaraan']; ?>)" class="delete">Hapus</button>
                    </td>
                </tr>
            <?php $no++;
            endwhile; ?>
            ...
            while ($row_mobil = mysqli_fetch_assoc($result_mobil)) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button onclick="konfirmasiHapus(<?= $row_mobil['id_Kendaraan']; ?>)" class="delete">Hapus</button>
    ...
    <script>
        function konfirmasiHapus(id) {
            var konfirhapus = confirm('Apakah Anda yakin ingin menghapus kendaraan ini?');
            if (konfirhapus) {
