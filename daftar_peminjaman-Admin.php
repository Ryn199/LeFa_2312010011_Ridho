...
$query_peminjaman = "SELECT * FROM `profil` LEFT JOIN peminjaman ON profil.id_User=peminjaman.id_Profil JOIN kendaraan ON peminjaman.id_Kendaraan=kendaraan.id_Kendaraan WHERE peminjaman.status_Peminjaman=2";
...
$query_riwayat_pengajuan = "SELECT * FROM `profil` LEFT JOIN riwayat ON profil.id_User=riwayat.id_Profil JOIN kendaraan ON riwayat.id_Kendaraan=kendaraan.id_Kendaraan WHERE level_Riwayat=1;";
...
$query_riwayat_peminjaman = "SELECT * FROM `profil` LEFT JOIN riwayat ON profil.id_User=riwayat.id_Profil JOIN kendaraan ON riwayat.id_Kendaraan=kendaraan.id_Kendaraan WHERE level_Riwayat=2;";
    ...
    <div id="content">
        ...
        <div id="pinjamanSaya" class="content-section">
            ...
            ?>
                    ...
                    <div class="pinjaman-box">
                        <div class="img-pinjam">
                            <img src="<?= $row_peminjaman['foto'] ?>" alt="<?= $row_peminjaman['foto'] ?>">
                            <div class="clear"></div>
                        </div>
                        ...
                        <table style="cursor: pointer;" onclick="window.location.href='detail_pinjaman.php?id=<?= $row_pengajuan['id_Kendaraan']; ?>'">
                            <tr>
                                <td>Nama</td>
                                <td>: <?= $row_peminjaman['nama']; ?></td>
                            </tr>
                            <tr>
                                <td>NIK Peminjam</td>
                                <td>: <?= $row_peminjaman['nik']; ?></td>
                            </tr>
                            <tr>
                                <td>Plat Nomor</td>
                ...
                <h2 style="text-align: center; margin: left 200px;">Belum ada yang mengajukan peminjaman</h2>
            <?php } ?>
        </div>
        ...
        <div id="riwayatPengajuan" class="content-section">
            ...
            ?>
                    <div class="pinjaman-box">
                        ...
                        <table onclick="window.location.href='detail_pinjaman.php?id=<?= $row_riwayat_pengajuan['id_Kendaraan']; ?>'">
                            <tr>
                                <td>Plat Nomor</td>
                ...
                <h2 style="text-align: center; margin: left 200px;">Tidak ada riwayat pengajuan yang tercatat</h2>
            <?php } ?>
        ...
        <div id="riwayatPeminjaman" class="content-section">
            ...
            ?>
                ...
                <h2 style="text-align: center; margin: left 200px;">Tidak ada riwayat peminjaman yang tercatat</h2>
            <?php } ?>
        </div>
