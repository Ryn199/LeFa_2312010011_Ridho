    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                ...
                <td>: <?php
                        if ($row_detail['waktu'] == '0000-00-00') {
                            echo '-';
                        } else {
            ...
            <tr>
                ...
                <td>: <?php
                        if ($row_detail['tanggal_Pengajuan'] == '0000-00-00') {
                            echo '-';
                        } else {
                            echo $row_detail['tanggal_Pengajuan'];
                        }
                        ?></td>            </tr>
            <tr>
                <td>Tanggal Dikonfirmasi</td>
                <td>: <?php
                        if ($row_detail['tanggal_Dikonfirmasi'] == '0000-00-00') {
                            echo '-';
                        } else {
                            echo $row_detail['tanggal_Dikonfirmasi'];
                        }
                        ?></td>            </tr>
            <tr>
                <td>Status</td>
