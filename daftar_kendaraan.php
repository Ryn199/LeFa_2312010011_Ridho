...
$query_motor = "SELECT kendaraan.*, peminjaman.tanggal_Dikonfirmasi, peminjaman.waktu
FROM kendaraan
LEFT JOIN peminjaman ON kendaraan.id_Kendaraan = peminjaman.id_Kendaraan
...
$query_mobil = "SELECT kendaraan.*, peminjaman.tanggal_Dikonfirmasi, peminjaman.waktu
                FROM kendaraan
                LEFT JOIN peminjaman ON kendaraan.id_Kendaraan = peminjaman.id_Kendaraan
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($row_motor['status_Kendaraan'] == 1) {
                            ...
                            echo "<br>";
                            echo $row_motor['tanggal_Dikonfirmasi'] . " sampai " . date('Y-m-d', strtotime($row_motor['tanggal_Dikonfirmasi'] . ' + ' . $row_motor['waktu'] . ' days'));
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($row_mobil['status_Kendaraan'] == 1) {
                            ...
                            echo "<span style='color: red;'>Dipinjam</span>";
                            echo "<br>";
                            echo $row_mobil['tanggal_Dikonfirmasi'] . " sampai " . date('Y-m-d', strtotime($row_mobil['tanggal_Dikonfirmasi'] . ' + ' . $row_mobil['waktu'] . ' days'));
